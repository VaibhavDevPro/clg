<form class="ajax-form" data-modal-form="#modal"      action="{{ route('food-categories.store') }}"
    ...
    <div class="d-flex flex-column gap-8">
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control"
                   value="{{ old('name') }}" required> <!-- No old foodCategory value -->
        </div>
        <div class="form-group">
            <label for="created_on" class="mb-2">Created On</label>
            <input type="date" name="created_on" id="created_on" class="form-control"
                   value="{{ old('created_on') }}" required> <!-- No old foodCategory value -->
        </div>
        <div class="form-group">
            <label for="created_by" class="mb-2">Created By</label>
            <input type="text" name="created_by" id="created_by" class="form-control"
                   value="{{ old('created_by') }}" required> <!-- No old foodCategory value -->
        </div>
        <div class="d-flex align-items-center justify-content-end gap-2">
            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary">Save Category</button> <!-- Always 'Save' -->
        </div>
    </div>
</form>
