                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Amount-->
                                                <span
                                                    class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">1,836</span>
                                                <!--end::Amount-->
                                                <!--begin::Badge-->
                                ...
                                <div class="card card-flush h-md-50 mb-xl-10">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            <!--begin::Amount-->
                                            <span
                                                class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">6.3k</span>
                                            <!--end::Amount-->
                                            <!--begin::Subtitle-->
                            ...
                            <div class="card-body d-flex flex-column flex-center">
                                ...
                                <div class="text-center mb-1">
                                    ...
                                    <a class="btn btn-sm btn-primary me-2"
                                        href="apps/ecommerce/customers/listing.html">Try now</a>
                                    <!--end::Link-->
                                    <!--begin::Link-->
                    ...
                    <div class="col-xl-4 mb-xl-10">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header flex-nowrap pt-5">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-900">Top Selling
                                        Categories</span>
                    ...
                    <div class="col-xl-4 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="apps/ecommerce/catalog/categories.html"
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--end::Heading-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-500">Online store convertion
                                        rate</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Visits by
                                        Source</span>
                                    <span class="text-gray-500 mt-1 fw-semibold fs-6">29.4k
                                        visitors</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-gray-500 pt-2 fw-semibold fs-6">Statistics by
                                        Countries</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
